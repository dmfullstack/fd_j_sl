 ...
 getDetails(): void {
    this._DetailsService.getDetails(this.id)
      .subscribe(data => {
       ...
       // console.log('we are inside details Component :' + JSON.stringify(this.restaurant));
      },
  ...
  getReviews(): void {
    this._DetailsService.getReviews(this.id)
      .subscribe(Reviews => {
        ...
        // console.log('Inside getReviews Component:' + JSON.stringify(this.user_reviews));
      },
      error => this.errorMessage = <any>error);
  }
  ...
  getMyReviews(): void {
    this._DetailsService.getMyReviews(this.id)
      .subscribe(Reviews => {
       ...
       // console.log('Inside getMyReviews Component:' + JSON.stringify(this.my_reviews));
      },
      error => this.errorMessage = <any>error);
  }
